...
Drugoplanowy przycisk **„Nie masz modelu? Opisz swój pomysł”** prowadzi do osobnego formularza modelowania. Klient przedstawia pomysł i materiały potrzebne do oceny, a MM3D najpierw sprawdza wykonalność oraz zakres pracy. Formularz nie podaje automatycznej ceny.
